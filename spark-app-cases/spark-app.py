...
trackingMessages = kafkaMessages.select(
    ...
    .withColumnRenamed('json.newCases', 'newCases') \
    .withColumnRenamed('json.newCuredCases', 'newCuredCases') \
...
popular = trackingMessages.groupBy(
    ...
    column("countryCode")
).sum('newCases', 'newCuredCases').withColumnRenamed('sum(newCases)', 'totalCases').withColumnRenamed('sum(newCuredCases)','curedCases')
...
def saveToDatabase(batchDataframe, batchId):
    ...
    def save_to_db(iterator):
        ...
        for row in iterator:
            ...
            sql.bind(row.countryCode, row.totalCases, row.curedCases).execute()
